...
def train():
    ...
    args = TrainingArguments(
        ...
        learning_rate=2.358098843991398e-05, per_device_train_batch_size=16, per_device_eval_batch_size=8,
        num_train_epochs=20, weight_decay=0.01, logging_strategy='steps', logging_steps=50, logging_dir='./logs', metric_for_best_model='precision',
    ...
    trainer.save_model('./ner_profession_model')
    print("Model saved.")
